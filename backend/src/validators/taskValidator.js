...
const create = [
  ...
  body('assigneeIds.*').optional({ checkFalsy: true }).isMongoId().withMessage('Invalid assignee ID'),
  ...
  body('parentTaskId').optional({ checkFalsy: true }).isMongoId().withMessage('Invalid parent task ID'),
  validate,
];
